  ...
  return (
    ...
    <Row>
      ...
      <div className='mt-5'>
        ...
        <div><span className='mr-2 days' onClick={handleThree2Show}>Day 3:</span><span>Florence</span></div>
        <div><span className='mr-2 days' onClick={handleFour2Show}>Day 4:</span><span>Florence</span></div>
        <div><span className='mr-2 days' onClick={handleFive2Show}>Day 5:</span><span>Tuscany day trip</span></div>
        <div><span className='mr-2 days' onClick={handleSix2Show}>Day 6:</span><span>Pisa</span></div>
        <div><span className='mr-2 days' onClick={handleSeven2Show}>Day 7:</span><span>Cinque Terre</span></div>
        <div><span className='mr-2 days' onClick={handleEight2Show}>Day 8:</span><span>Milan</span></div>
        <div><span className='mr-2 days' onClick={handleNine2Show}>Day 9:</span><span>Venice</span></div>
