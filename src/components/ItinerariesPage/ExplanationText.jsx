  ...
  return (
    <div className='itineraries'>
       <p className="my-5 mx-5" style={{fontSize: "13px", textAlign: "center"}}>
        ...
        Et fuga voluptas et inventore repellat et exercitationem dolores est quis asperiores sit earum corporis qui nemo quasi id aliquam explicabo. 
        At dolorem alias est doloribus vero aut magnam molestiae et explicabo sunt non consequatur enim et repellat sint.  
        </p>
    </div>
  )
}
