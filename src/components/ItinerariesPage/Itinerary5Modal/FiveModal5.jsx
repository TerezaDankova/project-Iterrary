...
const FiveModal5 = (props) => {

   const handleFive5Close = () => props.setFive5Show(false);

   return (
      <>
       <Modal size='xl' show={props.five5Show} onHide={handleFive5Close}>
