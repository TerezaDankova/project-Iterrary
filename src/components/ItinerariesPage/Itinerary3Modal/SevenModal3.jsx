...
const SevenModal3 = (props) => {

   const handleSeven3Close = () => props.setSeven3Show(false);

   return (
      <>
       <Modal size='xl' show={props.seven3Show} onHide={handleSeven3Close}>
