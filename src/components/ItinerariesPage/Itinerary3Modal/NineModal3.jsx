...
const NineModal3 = (props) => {

   const handleNine3Close = () => props.setNine3Show(false);

   return (
      <>
       <Modal size='xl' show={props.nine3Show} onHide={handleNine3Close}>
