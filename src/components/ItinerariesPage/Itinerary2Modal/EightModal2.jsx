...
const EightModal2 = (props) => {

   const handleEight2Close = () => props.setEight2Show(false);

   return (
      <>
       <Modal size='xl' show={props.eight2Show} onHide={handleEight2Close}>
