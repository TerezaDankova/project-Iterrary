...
const NineModal2 = (props) => {

   const handleNine2Close = () => props.setNine2Show(false);

   return (
      <>
       <Modal size='xl' show={props.nine2Show} onHide={handleNine2Close}>
