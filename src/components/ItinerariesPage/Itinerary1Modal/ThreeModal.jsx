...
const ThreeModal = (props) => {

   const handleThreeClose = () => props.setThreeShow(false);

   return (
      <>
      <Modal size='xl' show={props.threeShow} onHide={handleThreeClose}>
        <Modal.Header closeButton>
          <Modal.Title className="ml-4" style={{fontSize: '40px', fontWeight: 'bold', letterSpacing: '3px'}}>DAY THREE</Modal.Title>
        </Modal.Header>
        <Modal.Body>
           ...
           <div className='mt-3' style={{fontSize: '30px', fontWeight: 'bold'}}>AFTERNOON IN FLORENCE</div>
           ...
           <div className='mt-3' style={{fontSize: '20px', fontWeight: 'bold'}}>VISIT THE DUOMO AND CLIMB THE DOME</div>
           <div className=''> 
              <div><span style={{fontWeight: 'bold'}}>Hours:</span> Monday through Friday 8:15 am to 7:45 pm; Saturday 8:15 am to 5:30 pm; Sunday 12:45 pm to 5:30 pm</div>
              <div><span style={{fontWeight: 'bold'}}>Cost:</span> €20</div>
              <div><span style={{fontWeight: 'bold'}}>Website:</span>  www.duomoflorence.it </div>
           </div>
           ...
           <div className='mt-3' style={{fontSize: '20px', fontWeight: 'bold'}}>VISIT THE BAPTISTERY</div>
           <div className=''> 
              <div><span style={{fontWeight: 'bold'}}>Hours:</span>Weekdays: 8:15 am - 10:15 am, 11:15 am - 6:30 pm; Saturday 8:15 am - 6:30 pm; Sunday 8:15 am - 1:30 pm</div>
              <div><span style={{fontWeight: 'bold'}}>Cost:</span> €5</div>
              <div><span style={{fontWeight: 'bold'}}>Website:</span>  www.baptisteryflorence.it </div>
           </div>
           ...
           <div className='mt-3' style={{fontSize: '20px', fontWeight: 'bold'}}>ENJOY THE VIEW FROM GIOTTO'S BELL TOWER</div>
           <div className=''> 
              <div><span style={{fontWeight: 'bold'}}>Hours:</span>8:15 am - 7:30 pm</div>
              <div><span style={{fontWeight: 'bold'}}>Cost:</span> €15</div>
           </div>
           ...
           <div className='mt-5' style={{fontSize: '30px', fontWeight: 'bold'}}>PONTE VECCHIO & PIAZZALE MICHELANGELO</div>
           ...
           <Image className='mt-3' src={'https://images.pexels.com/photos/1533728/pexels-photo-1533728.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2'} fluid/>
