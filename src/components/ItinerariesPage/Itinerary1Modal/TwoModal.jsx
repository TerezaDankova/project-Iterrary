...
const TwoModal = (props) => {

   const handleTwoClose = () => props.setTwoShow(false);

   return (
      <>
       <Modal size='xl' show={props.twoShow} onHide={handleTwoClose}>
        <Modal.Header closeButton>
          <Modal.Title className="ml-4" style={{fontSize: '40px', fontWeight: 'bold', letterSpacing: '3px'}}>DAY TWO</Modal.Title>
        </Modal.Header>
        <Modal.Body>
